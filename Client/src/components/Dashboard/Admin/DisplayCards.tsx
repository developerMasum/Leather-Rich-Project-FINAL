      ...
      <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-2xl">৳{utils?.totalSoldMoney}</p>
          </div>
          <button
            type="button"
        ...
        <div className="mt-6">
          <button
            type="button"
            className="text-white p-3 w-1/2 hover:drop-shadow-xl"
            style={{ backgroundColor: 'rgb(3, 201, 215)', borderRadius: '10px' }}
          >
            Download
          </button>
        </div>
...
<div className="flex flex-col lg:flex-row w-full lg:w-9/12 gap-5">
      <div className="bg-white h-44 dark:text-gray-200 dark:bg-secondary-dark-bg md:w-full p-4 pt-9 rounded-2xl">
        <button type="button" className="text-2xl opacity-0.9 rounded-full p-4 hover:drop-shadow-xl" style={{ color: 'rgb(3, 201, 215)', backgroundColor: 'rgb(229, 250, 251)' }}>
        ...
        <p className="mt-3"><span className="text-lg font-semibold">{utils?.totalUsers}</span><span className="text-sm text-green-600 ml-2">+4%</span></p>
        <p className="text-sm text-gray-400 mt-1">Customers</p>
      </div>

      <div className="bg-white h-44 dark:text-gray-200 dark:bg-secondary-dark-bg md:w-full p-4 pt-9 rounded-2xl">
        <button type="button" className="text-2xl opacity-0.9 rounded-full p-4 hover:drop-shadow-xl" style={{ color: 'rgb(255, 244, 229)', backgroundColor: 'rgb(254, 201, 15)' }}>
          <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
            <path d="M8.186 1.113a.5.5 0 0 0-.372 0L1.846 3.5l2.404.961L10.404 2l-2.218-.887zm3.564 1.426L5.596 5 8 5.961 14.154 3.5l-2.404-.961zm3.25 1.7-6.5 2.6v7.922l6.5-2.6V4.24zM7.5 14.762V6.838L1 4.239v7.923l6.5 2.6zM7.443.184a1.5 1.5 0 0 1 1.114 0l7.129 2.852A.5.5 0 0 1 16 3.5v8.662a1 1 0 0 1-.629.928l-7.185 2.874a.5.5 0 0 1-.372 0L.63 13.09a1 1 0 0 1-.63-.928V3.5a.5.5 0 0 1 .314-.464L7.443.184z"></path>
          </svg>
        </button>
        <p className="mt-3"><span className="text-lg font-semibold">{utils?.totalProducts}</span><span className="text-sm text-green-600 ml-2">+23%</span></p>
        <p className="text-sm text-gray-400 mt-1">Products</p>
      </div>

      <div className="bg-white h-44 dark:text-gray-200 dark:bg-secondary-dark-bg md:w-full p-4 pt-9 rounded-2xl">
        <button type="button" className="text-2xl opacity-0.9 rounded-full p-4 hover:drop-shadow-xl" style={{ color: 'rgb(228, 106, 118)', backgroundColor: 'rgb(255, 244, 229)' }}>
        ...
        <p className="mt-3"><span className="text-lg font-semibold">{utils?.totalSoldItem}</span><span className="text-sm text-green-600 ml-2">+38%</span></p>
        <p className="text-sm text-gray-400 mt-1">Successful Orders</p>
      </div>

      <div className="bg-white h-44 dark:text-gray-200 dark:bg-secondary-dark-bg md:w-full p-4 pt-9 rounded-2xl">
        <button type="button" className="text-2xl opacity-0.9 rounded-full p-4 hover:drop-shadow-xl" style={{ color: 'rgb(0, 194, 146)', backgroundColor: 'rgb(235, 250, 242)' }}>
        ...
        <p className="mt-3"><span className="text-lg font-semibold">{utils?.totalOrders}</span><span className="text-sm text-red-600 ml-2">-12%</span></p>
