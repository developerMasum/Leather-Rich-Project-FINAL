    ...
    return (
      <div className="flex flex-col lg:flex-row justify-center gap-5 items-center w-full">
        <div className="w-full lg:w-3/12 lg:mx-3 mb-6 lg:mb-0">
          <div className="bg-red-300 dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">
        ...
        <div className="flex flex-col lg:flex-row w-full lg:w-9/12 gap-5">
          <div className="bg-red-200 h-44 dark:text-gray-200 dark:bg-secondary-dark-bg md:w-full p-4 pt-9 rounded-2xl">
            <button
              type="button"
            ...
            <p className="mt-3">
              <span className="text-lg font-semibold">00000</span>
              <span className="text-sm ps-2 text-green-600">items</span>
            </p>
            <p className="font-semibold text-gray-600 mt-1 uppercase">Bought Products</p>
          </div>
          ...
          <div className="bg-red-200 h-44 dark:text-gray-200 dark:bg-secondary-dark-bg md:w-full p-4 pt-9 rounded-2xl">
            ...
            <p className="mt-3">
              <span className="text-lg font-semibold">00000000</span>
          ...
          <div className="bg-red-200 h-44 dark:text-gray-200 dark:bg-secondary-dark-bg md:w-full p-4 pt-9 rounded-2xl">
            ...
            <p className="mt-3">
              <span className="text-lg font-semibold">000000000000</span>
          
            </p>
            <p className="font-semibold text-gray-600 mt-1 uppercase">Returned Products</p>
          </div>
        </div>
      </div>
    );
